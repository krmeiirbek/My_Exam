      ...
      body: Obx(() => RefreshIndicator(
        ...
        child: CustomScrollView(
          slivers: [
            ...
            if (!controller.state.isLoading.value) SliverToBoxAdapter(
              child: Padding(
                      ...
                      children: [
                        ...
                        InkWell(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color:
                              const Color.fromARGB(255, 152, 85, 204),
                              borderRadius: BorderRadius.circular(10),
                            ),
                            child: Text(
                              "Пәндік",
            ...
            ) else SliverToBoxAdapter(child: _loadingPage(),),
            !controller.state.isLoading.value ? SliverList(
    ...
    children: [
      ...
      Row(
        children: [
          Container(
            padding:
                const EdgeInsets.only(left: 20.0, right: 5.0, bottom: 10.0),
            width: 150,
            height: 50.0,
            child: Shimmer(
              gradient: LinearGradient(colors: [
